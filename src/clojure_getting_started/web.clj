...
(def input_data  (get-in (str (json-body-request (json-response (str (get-in (json-body-request request {:keywords? true :bigdecimals true}) [:body :result]))  {:keywords? true :bigdecimals true}) [:body :resolvedQuerry]  )) :resolvedQuerry))
